													...
													<tr>
														<td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
															...
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
																...
																<br>
																Thanks for joining Student Trade. Please confirm that your email address is correct to continue. click the link below to get started.
																...
																<hr style="margin-top: 10px; margin-bottom: 10px;">
																<br>
																<p> If you have any further questions please contact us at <a href="mailto:<?php echo get_section_content('contactus' , 'contactus_email_'.get_session('site_lang')); ?>"><?php echo get_section_content('contactus' , 'contactus_email_'.get_session('site_lang')); ?></a> </p>
																<br>
																<p> <b> Kind Regards,<br>
																Student Trade Support </b> </p>
