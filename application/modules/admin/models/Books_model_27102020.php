...
class Books_model extends CI_Model {
	...
	public function get_books_total()
	{
		$this->db->select('*');
	...
	{
		$this->db->select("st_books.*, users.first_name, users.email, st_used_books.book_condition, st_used_books.is_orderd, st_used_books.id as used_book_id");
