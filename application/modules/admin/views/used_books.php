    ...
    <div class="page-wrapper">
        <div class="page-header">
            ...
            <div class="page-header-breadcrumb">
                <a href="<?php echo admin_url(); ?>books/export_used_books" class="btn btn-inverse btn_inverse_white"><i class="fa fa-download"></i> Export Used Books</a>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($books as $book) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-danger btn-sm delete_used_book" data-id="<?php echo $book['used_book_id']; ?>" title="Delete Book"><i class="fa fa-trash"></i> Delete Book</button>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
<script type="text/javascript">
    ...
    $(document).on("click" , ".delete_used_book" , function() {
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    url:'<?php echo admin_url(); ?>books/delete_used_books',
                    type:'post',
                    dataType: 'json',
                    data:{id: id},
