<div class="modal-header">
    <h4 class="modal-title" id="myModalLabel">Release Payment to Seller</h4>
...
<div class="modal-body">
    ...
    <div>
        <label>Releaseable Amount:<b><?php echo $orders['trx_amount']; ?> CHF</b></label>
    </div>
