													...
													<tr>
														<td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
															...
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
																<p><legend><b style="color: #777777;">Dear <?php
																$user = get_owner_detail($user_id);
																echo $user['first_name']." ".$user['last_name'];
																?>,</b> </legend>  Your order has beed refunded. </p>

																<p> <strong>Transaction ID</strong> <?php echo $trx_id; ?> </p>
																<p> <strong>Amount Refund</strong> <?php echo $trx_amount; ?> CHF</p>
																<br>
