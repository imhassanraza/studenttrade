														...
														<td align="center" class="visible-xs">
															<div class="form-check">
																<label>
																	...
																	<input type="checkbox" value="<?php echo $book['id']; ?>" name="sell_books[]" <?php if(in_array($book['id'],$sell_session)) { ?> checked="" <?php } ?>>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="col-md-5 col-sm-6 col-xs-12 form-group pull-left">
										<!-- <select class="form-control" name="optional_module" id="optional_module" style="width: 100%;"> -->
											<select class="form-control js-example-basic-multiple" name="optional_module[]" id="optional_module" multiple="multiple" style="width: 100%;">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#optional_module').select2({
				placeholder: '<?php echo lang('choose_optional_module');?>'
			});
		});
