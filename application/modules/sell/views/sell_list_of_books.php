						...
						<div class="row">
															...
															<div class="form-check">
																<label>
																	<?php if(empty(get_session('sell_session'))) {
																		...
																		$sell_session = get_session('sell_session');
																	} ?>
																	<input type="checkbox" class="book_tag book_tag<?php echo $book['id']; ?>" value="<?php echo $book['id']; ?>" name="sell_books[]" <?php if(in_array($book['id'],$sell_session)) { ?> checked="" <?php } ?>>
								...
								<div class="col-md-5 col-sm-6 col-xs-12 form-group pull-left">
									<select class="form-control" name="optional_module" id="optional_module" style="width: 100%;">
										...
										<?php // foreach ($modules as $module) { ?>
											<option value="<?php // echo $module['module']; ?>" <?php // if(get_session('sell_session_optional_module') == $module['module']) { ?> selected="" <?php // } ?>> <?php // echo $module['module']; ?> </option>
										<?php // } ?>
									</select>
								</div>
							</div> -->
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="input-group">
									<input type="text" class="form-control" name="book_name" id="book_name" value="<?php echo get_session('book_name'); ?>" placeholder="<?php echo lang('author_year_title_module'); ?>">
